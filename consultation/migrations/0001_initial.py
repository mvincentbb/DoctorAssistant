    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date_time', models.DateTimeField()),
                ('mod_date_time', models.DateTimeField()),
                ('personne', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='consultation.Personne')),
            ],
            options={
                'db_table': 'patient',
                'managed': True,
        ...
        migrations.AddField(
            model_name='medecin',
            name='personne',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='consultation.Personne'),
        ),
        migrations.AddField(
            model_name='medecin',
            name='specialite',
